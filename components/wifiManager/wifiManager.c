...
esp_err_t wifiConnect() {
    ...
    //wait for connection
    xEventGroupWaitBits(wifi_event_group, WIFI_CONNECTED_EVENT, false, true, 60 * 1000 / portTICK_PERIOD_MS);
...
esp_err_t wifiProvisioning() {
    ...
    //wait for connection
    xEventGroupWaitBits(wifi_event_group, WIFI_CONNECTED_EVENT, false, true, 300 * 1000 / portTICK_PERIOD_MS);
